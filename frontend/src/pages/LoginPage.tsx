    ...
    <div style={{ minHeight:'100vh', background:'#f9fafb', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:font, padding:16 }}>
      <div style={{ width:'100%', maxWidth:400 }}>
        ...
        <div style={{ background:'#fff', borderRadius:12, padding:32, border:'1px solid #e5e7eb', boxShadow:'0 1px 3px rgba(0,0,0,0.04)' }}>
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ textAlign:'right', marginBottom:16 }}>
              <Link to="/forgot-password" style={{ fontSize:13, color:'#f97316', textDecoration:'none', fontWeight:500 }}>¿Olvidaste tu contrasena?</Link>
            </div>
        ...
        <p style={{ textAlign:'center', marginTop:20, fontSize:14, color:'#6b7280' }}>
          ¿No tienes cuenta? <Link to="/register" style={{ color:'#f97316', fontWeight:600, textDecoration:'none' }}>Registra tu restaurante</Link>
        </p>
      </div>
    </div>
  )
