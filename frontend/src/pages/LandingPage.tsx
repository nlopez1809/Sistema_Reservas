...
export default function LandingPage() {
  ...
  return (
    <div style={{ minHeight:'100vh', fontFamily:font, background:'#fff' }}>
      ...
      <a href="https://wa.me/59176806091" target="_blank" rel="noreferrer" style={{ position:'fixed', bottom:24, right:24, width:56, height:56, borderRadius:'50%', background:'#25d366', display:'flex', alignItems:'center', justifyContent:'center', boxShadow:'0 4px 12px rgba(0,0,0,0.15)', zIndex:999, textDecoration:'none' }}>
